...
const scripts = [
  [
    "Escreva aqui a primeira mensagem da conversa.",
  ],
  [
    "Escreva aqui a mensagem apresentada depois da primeira resposta.",
  ],
  [
    "Escreva aqui a mensagem que apresenta o pagamento por PIX.",
  ],
];
...
function startDownsells() {
  ...
  state.firstDownsell = setTimeout(() => {
    addMessage("Escreva aqui a mensagem da primeira oferta com desconto.");
    addOffer({ amount: 1995, oldAmount: 3990, title: "50% de desconto", description: "Descreva aqui a primeira oferta.", className: "discount" });
  }, 30_000);

  state.finalDownsell = setTimeout(() => {
    addMessage("Escreva aqui a mensagem da oferta final.");
    addOffer({ amount: 998, oldAmount: 3990, title: "75% de desconto", description: "Descreva aqui a oferta final.", className: "final" });
  }, 120_000);
}
